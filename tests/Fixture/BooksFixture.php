...
class BooksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'author' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'date_published' => ['type' => 'date', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-09-12 12:58:43',
                'modified' => '2019-09-12 12:58:43'
            ],
        ];
        parent::init();
    }
