...
class PublishersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 200, 'null' => true, 'default' => null, 'precision' => null, 'comment' => null, 'fixed' => null, 'collate' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-11-18 04:57:54',
                'modified' => '2019-11-18 04:57:54'
            ],
        ];
        parent::init();
    }
