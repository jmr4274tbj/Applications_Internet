...
class PublishersTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('Publishers') ? [] : ['className' => PublishersTable::class];
        $this->Publishers = TableRegistry::getTableLocator()->get('Publishers', $config);
    }
